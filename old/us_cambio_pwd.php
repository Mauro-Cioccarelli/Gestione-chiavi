...
if($_POST['Submit']) {
	...
	$mysqli->query("update keys_users set us_pwd_old=st_pwd where hid='$hid' and us_name='{$_POST['user']}'");
...
<div class="box1">
	<?php if($_GET['force']==1) { ?>
  <p class="testo22" style="text-align:center; color:#c00">E' necessario cambiare la password</p>
  	<?php } ?>
